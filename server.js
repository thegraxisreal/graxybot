...
// Serve static files from the 'graxybot' directory so assets like graxybot.png are found at root
app.use(express.static(path.join(__dirname, 'graxybot')));
// Also serve the root for any other needed files, though graxybot/ is primary for assets
